    ...
    <div className="max-w-4xl mx-auto px-6 py-10">
      ...
      <div className="bg-white dark:bg-slate-900/90 rounded-2xl border border-slate-200 dark:border-slate-800 p-8 shadow-sm dark:shadow-2xl">
        ...
        {step === 3 && (
          <div className="space-y-6">
            <div>
              <h2 className="heading-500 text-2xl font-medium tracking-tight text-[var(--text-main)]">Assign AI Account</h2>
              <p className="paragraph-300 text-sm mt-1 font-light text-[var(--text-main)] opacity-70">
            ...
            <div className="space-y-3">
              {eligibleAccounts.map((account) => {
                ...
                const remPercent = snapshot?.windows[0]?.remainingFraction !== undefined && snapshot?.windows[0]?.remainingFraction !== null
                ...
                return (
                  ...
                  >
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        <div className="flex items-center space-x-2">
                          <span className="heading-500 font-medium text-sm text-[var(--text-main)]">{account.displayAlias}</span>
                          {isRecommended && (
                            <span className="text-[10px] font-medium uppercase tracking-wider bg-amber-500/20 text-amber-700 dark:text-amber-400 px-2 py-0.5 rounded border border-amber-300 dark:border-amber-500/30">
                              🔥 USE SOON
                            </span>
                          )}
                          {tier && (
                            <span className={`text-[10px] font-medium px-1.5 py-0.5 rounded border ${tier.badgeBg} ${tier.badgeText} ${tier.badgeBorder}`}>
                              {tier.label}
                            </span>
                          )}
                        </div>
                        <span className="text-xs font-mono paragraph-300 font-light text-[var(--text-main)] opacity-70">
                          {remPercent !== null
                            ? `${remPercent}% quota remaining`
                            : 'Active account'}
                        </span>
                      </div>
                    </div>

                    <div className="text-right font-mono text-xs paragraph-300 font-light text-[var(--text-main)] opacity-70">
            ...
            <div className="p-6 rounded-2xl bg-amber-50 dark:bg-amber-950/40 border border-amber-300 dark:border-amber-500/40 space-y-4">
              ...
              <div className="space-y-2 text-sm paragraph-300 font-light text-[var(--text-main)]">
                <p>
                  ...
                  <strong className="font-medium text-amber-600 dark:text-amber-300">{selectedAccount?.displayAlias}</strong>.
                </p>
